...
If you are interested in pwn, do feel free to check out my earlier writeups on my blog where I talked about some [easy pwn challenges in RedPwnCTF 2020](/writeup/redpwn-coffer-overflow) as well as the [pwn challenges in Greyhats WelcomeCTF 2023](/writeup/greyhats-welcome-ctf-2023), which should include a few easier pwn challenges.
